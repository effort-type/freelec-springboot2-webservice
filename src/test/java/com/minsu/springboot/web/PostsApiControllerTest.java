...
public class PostsApiControllerTest {
    ...
    @Test
    @WithMockUser(roles="USER") //인증된 가짜 사용자를 만들어서 사용하는 어노테이션
    public void Posts_Register() throws Exception {
        ...
        //when
        //ResponseEntity<Long> requestEntity = restTemplate.postForEntity(url, requestDto, Long.class);
        ...
        //then
//        assertThat(requestEntity.getStatusCode()).isEqualTo(HttpStatus.OK);
//        assertThat(requestEntity.getBody()).isGreaterThan(0L);
//
